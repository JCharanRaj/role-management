...
public class CreateRoleService {
	...
	public ResponseEntity<ViewResponse> createRole(CreateRoleRequest createRoleRequest) {
		...
		Optional<Roles> roleOpt = rolesRepository.findByRoleAndOrganizationId(createRoleRequest.getName(),userOptional.get().getOrgansationId());
		...
		role.setOrganizationId(userOptional.get().getOrgansationId());
